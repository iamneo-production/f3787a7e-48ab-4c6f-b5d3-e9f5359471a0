...
public class KeyUtils {
    @Autowired
    Environment environment;  // for key generation in development profile
    ...
    public String getBase64PublicKey() throws IOException {
        File publickeyFile = new File(accessTokenPublicKeyPath);
        byte[] publicKeyBytes = Files.readAllBytes(publickeyFile.toPath());
